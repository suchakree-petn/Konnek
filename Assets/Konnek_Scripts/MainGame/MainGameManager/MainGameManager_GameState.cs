...
public partial class MainGameManager
{
    ...
    {
        switch (MainGameContext.GetCurrentGameState())
        {
            case MainGameState.Player_1_Start_Turn:
                OnStartTurn_Player_1?.Invoke(MainGameContext);
                MainGameContext.SetCurrentGameState(MainGameState.Player_1_During_Turn);
                break;
            ...
            case MainGameState.Player_1_End_Turn:
                ...
                MainGameContext.SetCurrentGameState(MainGameState.Player_2_Start_Turn);
                break;
            case MainGameState.Player_2_Start_Turn:
                OnStartTurn_Player_2?.Invoke(MainGameContext);
                MainGameContext.SetCurrentGameState(MainGameState.Player_2_During_Turn);
                break;
